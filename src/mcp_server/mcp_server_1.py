...
def main():
    """Entry point for the FRR MCP server 1."""
    ...
    # Start MCP server with streamable-http transport on port 8001
    logger.info("Starting FRR MCP server 1 on port 8001")
